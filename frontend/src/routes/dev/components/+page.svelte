...
<main class="mx-auto grid w-full max-w-7xl justify-items-center gap-10 px-8 py-14">
  ...
  <section class="grid w-full grid-cols-4 gap-10 place-items-center max-xl:grid-cols-2 max-md:grid-cols-1">
