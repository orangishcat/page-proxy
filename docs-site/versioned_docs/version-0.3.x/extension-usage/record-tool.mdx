...
<img src={useBaseUrl("/img/editor_usage/record_timeline.avif", { absolute: true })} alt="Page Proxy Record tool timeline" />
<img
...
> New in v0.3.0: the review step now reuses the latest code from previous steps, so edits made earlier in the converter carry through to the final combined output.
