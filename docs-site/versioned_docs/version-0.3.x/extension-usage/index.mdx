...
New in v0.3.6: when the current tab already has a matching saved script, the toolbar script dropdown stays available and includes a **New script** action for starting another script on the same tab.
