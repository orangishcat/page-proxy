...
- Content fetched from the GitHub repository at [`extension/HELP.md`](https://github.com/orangishcat/page-proxy/blob/main/extension/HELP.md), rendered as markdown.
